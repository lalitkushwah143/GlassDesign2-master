package com.example.android.glass.glassdesign2.util;
...
public final class RenderTextView {

    public static final String TAG = "RenderTextView";
    ...
    public RenderTextView(Activity activity) {
        this.activity = activity;

        LayoutInflater factory = LayoutInflater.from(this.activity);
        alertView = factory.inflate(R.layout.textview_alert, null);
        alertImagesLayout = alertView.findViewById(R.id.textview_alert_imageview);
        alertText = alertView.findViewById(R.id.textview_alert_tvContent);
    }
    ...
    public void setMarginTop(int marginTop) {
        ...
        alertView.post(new Runnable() {
            ...
            public void run() {
                FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) alertView.getLayoutParams();
                layoutParams.setMargins(0, RenderTextView.this.marginTop, 0, 0);
                alertView.setLayoutParams(layoutParams);
            }
        });
    }
