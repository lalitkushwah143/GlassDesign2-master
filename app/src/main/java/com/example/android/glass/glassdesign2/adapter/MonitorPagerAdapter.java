...
public class MonitorPagerAdapter extends PagerAdapter implements CardAdapter {

    private List<CardView> mViews;
    private List<DataLoad> mData;
    private List<TextView> mTexts;
    private List<TextView> mHints;
    private float mBaseElevation;
    private Context context;

    public MonitorPagerAdapter(Context context) {
    ...
    public void addCardItem(DataLoad item) {
        mViews.add(null);
        mTexts.add(null);
        mHints.add(null);
        mData.add(item);
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        View view = LayoutInflater.from(container.getContext())
                .inflate(R.layout.list_monitor, container, false);
        container.addView(view);
        bind(mData.get(position), view);
        cardView = (CardView) view.findViewById(R.id.list_monitor_cardview);
        textView = (TextView) view.findViewById(R.id.list_monitor_title);
        tvBottom = (TextView) view.findViewById(R.id.list_monitor_tvBottom);
        ConstraintLayout layout = view.findViewById(R.id.list_monitor_layout);
    ...
    private void bind(DataLoad item, View view) {

        TextView titleTextView = (TextView) view.findViewById(R.id.list_monitor_title);
