...
public class ConstraintSetHelper {
    ...
    public void layoutViewWithLeftBound(int viewId, int leftBound) {
        set.connect(viewId, ConstraintSet.LEFT, leftBound, ConstraintSet.LEFT);
    }

    public void layoutViewWithRightBound(int viewId, int rightBound) {
        set.connect(viewId, ConstraintSet.RIGHT, rightBound, ConstraintSet.RIGHT);
    }

    public void layoutViewNextToView(int leftViewId, int rightViewId, int leftBoundViewId, int rightBoundViewId) {
    ...
    public void layoutViewFullScreen(int viewId) {
        ...
        layoutViewWithRightBound(viewId, container);
        layoutViewWithLeftBound(viewId, container);
    }
